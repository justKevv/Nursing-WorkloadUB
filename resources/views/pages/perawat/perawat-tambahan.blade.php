<x-layout bodyClass="g-sidenav-show  bg-gray-200">
        <x-navbars.bottombar activePage="tambahan"></x-navbars.bottombar>
        <style>
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            <!-- Navbar -->
            <x-navbars.navs.perawat titlePage="Tambahan"></x-navbars.navs.auth>
            <!-- End Navbar -->
                        ...
                        <div class="card my-4">
                            ...
                            <div class="card-body px-3 pb-2">
                                <section class="container my-1">
                                    <h5 class="card-title text-center mb-3">Tambah Jenis Tindakan Tambahan</h5>
