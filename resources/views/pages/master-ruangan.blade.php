<x-layout bodyClass="g-sidenav-show  bg-gray-200">
        <x-navbars.sidebar activePage="master-ruangan"></x-navbars.sidebar>
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            <!-- Navbar -->
            <x-navbars.navs.master titlePage="Ruangan"></x-navbars.navs.auth>
            <!-- End Navbar -->
                        ...
                        <div class="card my-4">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-3 pb-2">
                                    <h5 class="text-white text-capitalize ps-3">Ruangan table</h5>
                                </div>
                            </div>
                                                ...
                                                <td>
                                                    <div class="d-flex ps-4 py-1">
                                                        ...
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <h6 class="mb-0 text-md">{{ $shift->nama_ruangan }}</h6>
                                                        </div>
                                                    </div>
                                                </td>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                $('#author_table').DataTable({
                    ...
                    columnDefs: [
                        { targets: 1, orderable: false }  // Kolom pertama tidak bisa diurutkan
                    ]
                });
            });
        </script>
